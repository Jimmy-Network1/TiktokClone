...
const MOCK_VIDEOS: Video[] = [
  {
    id: 'mock-1',
    video_url: 'https://v.ftsh7.com/video/21213/mixkit-girl-in-neon-lighting-in-the-city-at-night-21213-medium.mp4',
    thumbnail_url: 'https://images.pexels.com/photos/2387418/pexels-photo-2387418.jpeg',
    caption: 'Bienvenue sur G4 ! 🚀 Le futur du contenu court est ici. #G4 #NextGen #Fun',
    user_id: 'system',
  ...
  {
    id: 'mock-4',
    video_url: 'https://v.ftsh7.com/video/4686/mixkit-skateboarding-trick-in-the-park-4686-medium.mp4',
    thumbnail_url: 'https://images.pexels.com/photos/1018484/pexels-photo-1018484.jpeg',
    caption: 'Check ce trick ! 🛹 #Skate #TrickShot #G4',
    user_id: 'system',
    profiles: { username: 'SkateMaster', avatar_url: 'https://i.pravatar.cc/150?u=skate', full_name: 'Tony G' },
    likes: [{ user_id: '1' }, { user_id: '5' }],
    comments: [{ id: 'c10' }],
  },
  {
    id: 'mock-3',
    video_url: 'https://v.ftsh7.com/video/1188/mixkit-waves-in-the-ocean-at-sunset-1188-medium.mp4',
  ...
  {
    id: 'mock-5',
    video_url: 'https://v.ftsh7.com/video/24545/mixkit-young-woman-dancing-in-a-park-on-a-sunny-day-24545-medium.mp4',
    thumbnail_url: 'https://images.pexels.com/photos/1102341/pexels-photo-1102341.jpeg',
    caption: 'Vibe du matin ! ✨ #Dance #Happy #G4Vibes',
    user_id: 'system',
    profiles: { username: 'Joy_Dance', avatar_url: 'https://i.pravatar.cc/150?u=dance', full_name: 'Joy Smith' },
